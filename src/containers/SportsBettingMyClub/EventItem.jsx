...
const EventItem = ({ activityclubId,activityName, levelname, location, numberOfTeams, avatar, startDate,numberOfParticipants }) => {
  const navigate = useNavigate();
  
  const handleButtonClick = (href) => {
    if (href !== '#') {
      navigate(`/detailmatchmyclub/${activityclubId}`); // Truyền activityId qua đường dẫn
    }
  };
    ...
    <article className={styles.eventItem}>
      ...
      <div className={styles.eventContent}>
        ...
        <p className={styles.eventParticipants}>
          ...
          />
          Thành viên tham gia: {numberOfParticipants}/{numberOfTeams}
        </p>
